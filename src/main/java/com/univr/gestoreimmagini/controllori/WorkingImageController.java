...
import com.univr.gestoreimmagini.custom.AnnotationListCell;
import com.univr.gestoreimmagini.custom.ResizableRectangle;
...
public class WorkingImageController implements Initializable {
    ...
    public WorkingImageController(){
        try {
            voidImage = new Image(getClass().getResource("/com/univr/gestoreimmagini/immagini/void.png").openStream());
        } catch (IOException e) {
